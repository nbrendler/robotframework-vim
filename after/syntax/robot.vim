...
" Last Update: Thu Feb 16, 2012 19:54 GTB Standard Time
"------------------------------------------------------------------------
" Description:
...
" Matches
"------------------------------------------------------------------------
syn match robotTestCaseName "^|\s\+\zs\([^|]\+\)\ze\(\s|\)\?$"
